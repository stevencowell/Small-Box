(function () {
  ...
  brand.innerHTML = '<span class="course-family-nav__mark" aria-hidden="true">SB</span><span>Small Box</span>';
  ...
  const items = [
    ...
    ["Modules", "index.html#pathway", /\/weeks\d+-\d+\//.test(path)],
    ...
    ["My folio", "smallbox-folio.html", path.endsWith("/smallbox-folio.html")],
