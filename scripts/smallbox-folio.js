...
const CARDS=[
  ["brief","Project brief and success criteria","Show that you understand the Small Box requirements and how evidence is judged in this unit.","Brief analysis, recorded teacher-confirmed open or lidded choice, success criteria, and a link between the plan and expected quality checks.","What must your Small Box do and what evidence proves it was achieved?",["My Small Box must…","My evidence will prove…"],"A completed Small Box matched to clear function, safety and quality requirements."],
  ...
  ["joints","Approved joinery and dry fitting","Explain how the confirmed joints and rebates were checked before square glue-up.","Source checks, dovetail, rebate and finger-joint notes, dry-fit observations, square validation and correction records.","Which joint or alignment check changed your confidence the most?",["The approved feature was…","I checked and corrected the fit by…"],"A joinery sequence diagram showing the confirmed features, dry-fit checks and correction stages."],
  ...
  ["evaluation","PMI evaluation","Evaluate the final project with balanced strengths, limits and questions.","Final function, fit and finish checks, limitations and transfer ideas. Include lid/hinge checks only where fitted; for an open box, use opening, edge and access evidence.","How strongly does your Small Box meet the brief?",["A plus supported by evidence is…","A minus with evidence is…","An interesting next question is…"],"A final PMI map across function, fit, finish, process quality and transfer."],
